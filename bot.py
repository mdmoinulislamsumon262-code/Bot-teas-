"""
🌸 LUXURY PINK DIGITAL SHOP BOT — COMPLETE FLAWLESS EDITION 🌸
Features: Buyer Username & ID in Orders, 7-Day Admin Configurable Streak, 1-Click Promo, Live 3s Mail OTP & 50K Load-Ready.
"""
...
# ৫০,০০০ ইউজারের লোড অনায়াসে নেওয়ার জন্য ২০টি ব্যাকগ্রাউন্ড ওয়ার্কার থ্রেড
...
def on_callback(call):
    ...
    if data.startswith("shop_confirm:"):
        ...
        send(ADMIN_ID, admin_order_alert)
