"""
🌸 LUXURY PINK DIGITAL SHOP BOT — 50K CONCURRENCY & ZERO-CRASH EDITION 🌸
Optimized with SQLite WAL Cache, High-Speed Multithreading, Live In-place 2FA & 3s Mail OTP.
"""
...
def init_db():
    with conn() as c:
        ...
        -- হাই-স্পিড ইনডেক্সিং (৫০ হাজার ইউজারের জন্য ইনস্ট্যান্ট কুয়েরি রেসপন্স)
...
# ═══════════════════════════════════════════════════════════════════════════
# 🌸 কীবোর্ড ও মেনু লেআউট (Clean & Aesthetic)
# ═══════════════════════════════════════════════════════════════════════════
