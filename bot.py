"""
🌸 PINK LUXURY DIGITAL SHOP BOT — CATEGORY FIXED & INSTANT BUY EDITION 🌸
Features: Renamed to 'Product', Fixed Category Buy Flow, Logo Support, 3s Auto-Refresh Mail OTP, In-place 2FA & Render 24/7.
"""
...
def handle_media_messages(message):
    ...
    # Upload logo/photo during Add Product
...
# ═══════════════════════════════════════════════════════════════════════════
# 🔘 ইনলাইন বাটন ও কলব্যাক হ্যান্ডলার (Fixed Callback Routing)
# ═══════════════════════════════════════════════════════════════════════════
...
def on_callback(call):
    ...
    # Category / List Pagination (FIXED)
